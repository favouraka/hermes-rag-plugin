...
def register(ctx):
    ...
    try:
        ...
        _peer_manager = peer_model.PeerManager(db_path=str(db_path))
        logger.info("✓ Peer manager initialized")

        _session_manager = session.SessionManager(db_path=str(db_path))
        logger.info("✓ Session manager initialized")

        _auto_capture = auto_capture.AutoPeerCapture(db_path=str(db_path))
        logger.info("✓ Auto peer capture initialized")

        _isolation = namespace.NamespaceIsolation(db_conn=_auto_capture.conn)
        logger.info("✓ Namespace isolation initialized")

        _rag_core = rag_core.RAGCore()
        ...
        ctx.register_tool(
            ...
            schema=schemas.RAG_GET_PEER_CONTEXT,
        ...
        ctx.register_tool(
            ...
            schema=schemas.RAG_GET_SESSION_CONTEXT,
        ...
        ctx.register_tool(
            ...
            schema=schemas.RAG_START_SESSION,
        ...
        ctx.register_tool(
            ...
            schema=schemas.RAG_END_SESSION,
        ...
        ctx.register_tool(
            ...
            schema=schemas.RAG_CAPTURE_MESSAGE,
        ...
        ctx.register_tool(
            ...
            schema=schemas.RAG_LIST_SESSIONS,
